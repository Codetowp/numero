...
class Numero_Premium extends WP_Widget{
    ...
    function __construct() 
    {
		...
		function Numero_Premium_widget_scripts(){
		  ...
		  wp_enqueue_script( 'Numero_Premium_widget_scripts', get_template_directory_uri() . '/js/widget.js', false, '1.0', true );
  ...
  ?>
    ...
    public function form( $instance ) {
        ...
        ?>
         ...
         <p>
            <label for="<?php echo $this->get_field_id('facebook_url'); ?>"><?php esc_html_e( 'Facebook Url', 'numero' ); ?></label><br/>
            ...
            <input type="text" name="<?php echo $this->get_field_name('facebook_url'); ?>"
                   ...
                   class="list-inline top-social-link"/>
        </p>


        <p>

            <label for="<?php echo $this->get_field_id('twitter_url'); ?>"><?php esc_html_e( 'Twitter Url', 'numero' ); ?></label><br/>
        ...
        <p>
            ...
            <label for="<?php echo $this->get_field_id('google_url'); ?>"><?php esc_html_e( 'Google Url', 'numero' ); ?></label><br/>
        ...
        <p>
            ...
            <label for="<?php echo $this->get_field_id('inst_title'); ?>"><?php esc_html_e( 'Instagram Title', 'numero' ); ?></label><br/>
         ...
         <p>
            ...
            <label for="<?php echo $this->get_field_id('dribbble'); ?>"><?php esc_html_e( 'Dribbble Url', 'numero' ); ?></label><br/>
        ...
        <p>
            ...
            <label for="<?php echo $this->get_field_id('behance'); ?>"><?php esc_html_e( 'Behance Url', 'numero' ); ?></label><br/>
