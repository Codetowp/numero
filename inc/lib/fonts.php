...
function customizer_library_get_all_fonts() {
	$heading1       = array( 1 => array( 'label' => sprintf( '--- %s ---', __( 'Standard Fonts', 'numero' ) ) ) );
	$standard_fonts = customizer_library_get_standard_fonts();
	$heading2       = array( 2 => array( 'label' => sprintf( '--- %s ---', __( 'Google Fonts', 'numero' ) ) ) );
...
function customizer_library_get_google_font_subsets() {
	return array(
		'all'          => __( 'All', 'numero' ),
		'cyrillic'     => __( 'Cyrillic', 'numero' ),
		'cyrillic-ext' => __( 'Cyrillic Extended', 'numero' ),
		'devanagari'   => __( 'Devanagari', 'numero' ),
		'greek'        => __( 'Greek', 'numero' ),
		'greek-ext'    => __( 'Greek Extended', 'numero' ),
		'khmer'        => __( 'Khmer', 'numero' ),
		'latin'        => __( 'Latin', 'numero' ),
		'latin-ext'    => __( 'Latin Extended', 'numero' ),
		'vietnamese'   => __( 'Vietnamese', 'numero' ),
	);
}
endif;
...
function customizer_library_get_standard_fonts() {
	return array(
		'serif' => array(
			'label' => _x( 'Serif', 'font style', 'numero' ),
			'stack' => 'Georgia,Times,"Times New Roman",serif'
		),
		'sans-serif' => array(
			'label' => _x( 'Sans Serif', 'font style', 'numero' ),
			'stack' => '"Helvetica Neue",Helvetica,Arial,sans-serif'
		),
		'monospace' => array(
			'label' => _x( 'Monospaced', 'font style', 'numero' ),
