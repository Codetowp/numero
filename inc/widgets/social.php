...
class Numero_Premium extends WP_Widget{
    ...
    {
        parent::__construct(
            'numero-premium-widget', // Base ID
            esc_attr__( 'Numero -Sidebar social widget', 'numero' ), // Name
            array( 
		...
		function numero_premium_widget_scripts(){
			wp_enqueue_media();
			wp_enqueue_script( 'numero_premium_widget_script', get_template_directory_uri() . '/js/widget.js', false, '1.0', true );
		}
		add_action('admin_enqueue_scripts', 'numero_premium_widget_scripts');
        }
    }
	...
	$title = apply_filters('widget_title', empty($instance['social_title']) ? __('Follow us', 'numero') : $instance['social_title'], $instance, $this->id_base);
	?>
    
        <h2 class="widget-title"> <?php if ( $title ) echo esc_html( $title ); ?></h2>
          <ul class="list-inline">
              <?php if( !empty( $instance['facebook_url'] ) ){?>
            <li ><a href="<?php if( !empty( $instance['facebook_url'] ) ): echo esc_url(apply_filters( 'widget_title', $instance['facebook_url'] ) ); endif; ?>" title="<?php esc_html_e('facebook', 'numero'); ?>"><i class="fa fa-facebook"></i></a></li>
              <?php }?>
               <?php if( !empty( $instance['twitter_url'] ) ){?>
            <li ><a href="<?php if( !empty( $instance['twitter_url'] ) ): echo esc_url(apply_filters( 'widget_title', $instance['twitter_url'] ) ); endif; ?>" title="<?php esc_html_e('twitter', 'numero'); ?>"><i class="fa fa-twitter"></i></a></li>
               <?php }?>
              <?php if( !empty( $instance['google_url'] ) ){?>
            <li ><a href="<?php if( !empty( $instance['google_url'] ) ): echo esc_url(apply_filters( 'widget_title', $instance['google_url'] ) ); endif; ?>" title="<?php esc_html_e('google-plus', 'numero'); ?>"><i class="fa fa-google-plus"></i></a> </li>
              <?php }?>
			  <?php if( !empty( $instance['dribbble'] ) ){?>
            <li ><a href="<?php if( !empty( $instance['dribbble'] ) ): echo esc_url(apply_filters( 'widget_title', $instance['dribbble'] ) ); endif; ?>" title="<?php esc_html_e('dribbble', 'numero'); ?>"><i class="fa fa-dribbble"></i></a> </li>
              <?php }?>
               <?php if( !empty( $instance['behance'] ) ){?>
            <li ><a href="<?php if( !empty( $instance['behance'] ) ): echo esc_url(apply_filters( 'widget_title', $instance['behance'] ) ); endif; ?>" title="<?php esc_html_e('behance', 'numero'); ?>"><i class="fa fa-behance"></i></a> </li>
              <?php }?>
              <?php if( !empty( $instance['inst_title'] ) ){?>
            <li ><a href="<?php if( !empty( $instance['inst_title'] ) ): echo esc_url(apply_filters( 'widget_title', $instance['inst_title'] ) ); endif; ?>" title="<?php esc_html_e('instagram', 'numero'); ?>"><i class="fa fa-instagram"></i></a>
                <?php 
    ...
    public function form( $instance ) {
        ...
        ?>
         ...
         <p>
            <label for="<?php echo esc_html($this->get_field_id('social_title')); ?>"><?php esc_html_e( 'Social Title', 'numero' ); ?></label><br/>
         ...
         <p>
            <label for="<?php echo esc_html($this->get_field_id('facebook_url')); ?>"><?php esc_html_e( 'Facebook Url', 'numero' ); ?></label><br/>
        ...
        <p>
            <label for="<?php echo esc_html($this->get_field_id('twitter_url')); ?>"><?php esc_html_e( 'Twitter Url', 'numero' ); ?></label><br/>
        ...
        <p>
            <label for="<?php echo esc_html($this->get_field_id('google_url')); ?>"><?php esc_html_e( 'Google Url', 'numero' ); ?></label><br/>
        ...
        <p>
            <label for="<?php echo esc_html($this->get_field_id('inst_title')); ?>"><?php esc_html_e( 'Instagram Title', 'numero' ); ?></label><br/>
         ...
         <p>
            <label for="<?php echo esc_html($this->get_field_id('dribbble')); ?>"><?php esc_html_e( 'Dribbble Url', 'numero' ); ?></label><br/>
        ...
        <p>
            <label for="<?php echo esc_html($this->get_field_id('behance')); ?>"><?php esc_html_e( 'Behance Url', 'numero' ); ?></label><br/>
...
register_widget( 'Numero_Premium' );
?>