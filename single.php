...
<div id="Blog-post"> 
  ...
  <header class="entry-header" style="background-image: url(<?ph echo get_template_directory_uri(); ?>/img/s-1.jpg);">
    ...
    <div class="row wow fadeInUp"> 
      ...
      <div class="col-md-8 col-sm-8 single-post">
        <article class="post"> 
          ...
          <p> With the first generation of Bitcoin businesses like Mt. Gox less influential today, the hopes of ‘mass-marketizing’ virtual currencies are held by venture capital-backed companies like BitPay, which recently raised $30 million, Coinbase, which raised a $25 million Series B round last year, and Circle. Interestingly, it looks like a significant transaction took the cyber currency over today’s landmark. That’s a reminder that though many people see the future of Bitcoin as leveling the playing field for all, there are </p>
          <figure ><img src="img/06-screenshot.jpg" class="img-responsive">
...
label-warning">Warning</span>&nbsp;<span class="label label-danger">Danger</span>&nbsp;<span class="label disabled label-default">Danger</span>
    ...
    ================================================== -->
          ...
          <button class="btn btn-primary" type="button" data-toggle="collapse" data-target="#collapseExample">Btn data-target</button>
